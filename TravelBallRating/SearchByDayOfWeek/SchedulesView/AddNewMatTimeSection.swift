...
//    @Binding var daySelected: Bool
    ...
    let selectTeamAndDay: (Team, DayOfWeek) async -> AppDayOfWeek?
    ...
    func handleSelectedDayChange() {
        ...
        Task {
            ...
            let appDayOfWeek = await selectTeamAndDay(selectedTeam, selectedDay)
    ...
    func addNewMatTime() {
        ...
        guard let selectedTeam,
            ...
            presentAlert(
                title: "Error",
                message: "Selected Team or Day is missing."
            )
            return
        }
        ...
        do {
            ...
            if let existingAppDayOfWeek = viewModel.selectedAppDayOfWeek {
                ...
                appDayOfWeekToUseID = try backgroundContext.performAndWait {
                        ...
                        throw NSError(
                            ...
                            userInfo: [
                                NSLocalizedDescriptionKey:
                                    "Failed to rehydrate selectedTeam in background context."
                            ]
                        )
                    }
                    ...
                    let humanReadableID = "\(teamNameSafe)-\(dayNameSafe)"
    ...
    func saveMatTime(appDayOfWeekID: NSManagedObjectID) async throws -> NSManagedObjectID {
        ...
        guard let selectedTeam = self.selectedTeam,
              let selectedDay = self.selectedDay else {
            print("❌ Missing necessary information: Team or Day is nil")
            throw NSError(domain: "AddNewMatTimeSectionError", code: 1,
                          userInfo: [NSLocalizedDescriptionKey: "Selected Team or Day is missing."])
        }
