        ...
        VStack(spacing: 0) {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    // Teams Section
                    sectionHeader("Manage Teams")
                    menuLink("All Teams", destination: ContentView(persistenceController: persistenceController))
                    menuLink("ALL Team Schedules", destination: teamScheduleView(viewModel: appDayOfWeekViewModel))
                    menuLink("ALL Practice Schedules", destination: AllteamScheduleView(
                    ...
                    menuLink("Delete Team Record", destination: DeleteRecordView(
