    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                Text("TravelBallRating Privacy Policy")
                    .font(.largeTitle)
                    .fontWeight(.bold)
                    .padding(.bottom, 10)
                ...
                Text("""
                    TravelBallRating ("we," "us," or "our") is committed to protecting the privacy of our users ("you" or "your"). This Privacy Policy explains what information we collect, how we use it, and under what circumstances we may disclose it.
                    """)
                    .padding(.bottom, 10)
                ...
                Text("""
                    ...
                    - **To provide and improve TravelBallRating:** We may use your location (if shared) to show nearby BJJ teams and open mats. Your email may be used for communication purposes.
                ...
                Text("""
                    We do not share personal information with third parties without your consent, except for non-personal information shared with service providers to help us operate TravelBallRating. We may disclose information if required by law or to protect the rights of others.
                    """)
                ...
                Text("""
                    We take reasonable steps to protect your information from unauthorized access, disclosure, alteration, or destruction. Passwords are securely hashed using industry-standard methods and are not stored in plain text. We do not store or retain plain-text passwords, and they are not visible to any developer or anyone at TravelBallRating. However, no internet transmission or electronic storage is completely secure.
                    """)
                ...
                Text("""
                    TravelBallRating is not intended for children under 13. If you believe your child has provided us with personal information, please contact us and we will delete it.
                    """)
