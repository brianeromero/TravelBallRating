...
struct TeamMenu2: View {
    ...
    init(profileViewModel: ProfileViewModel, navigationPath: Binding<NavigationPath>) {
        ...
        let teamViewModel = TeamViewModel(persistenceController: sharedPersistenceController)
    ...
    enum TeamMenuOption: String, CaseIterable, Identifiable {
        ...
        case addNewTeam = "Add New team"
        case updateExistingTeams = "Update Existing teams"
        ...
        var iconName: String {
            ...
            case .addNewTeam: return "plus.circle"
            case .updateExistingTeams: return "rectangle.and.pencil.and.ellipsis"
    ...
    private var menuItemsFlat: [TeamMenuOption] {
        var items: [TeamMenuOption] = [
            .empty,
            .allLocations,
            .currentLocation,
            .postalCode,
    ...
    @ViewBuilder
    private func renderMenuItem(_ option: TeamMenuOption) -> some View {
        if option == .profile {
            if isLoggedIn {
            ...
            Button {
                ...
                case .dayOfWeek, .addNewteam, .updateExistingTeams, .addOrEditScheduleOpenMat:
    ...
    private func menuItemLabel(for option: TeamMenuOption, locked: Bool = false) -> some View {
        HStack {
    ...
    private var restrictedItems: [TeamMenuOption] {
        [.dayOfWeek, .addNewTeam, .updateExistingTeams, .addOrEditScheduleOpenMat, .submitReview]
    }

    // MARK: - Navigation Destination
    private func navigationDestination(for option: TeamMenuOption) -> AppScreen {
        switch option {
        ...
        case .submitReview: return .selectTeamForReview
