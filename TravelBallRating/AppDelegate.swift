...
class AppDelegate: UIResponder, UIApplicationDelegate, MessagingDelegate, UNUserNotificationCenterDelegate {
    ...
    // App-wide shared instances - These will be passed to TravelBallRatingApp for environment injection
    ...
    func application(
        ...
        self.teamViewModel = TeamViewModel(persistenceController: PersistenceController.shared)
