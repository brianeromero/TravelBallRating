...
struct TeamInformationSection: View {
    ...
    // Define teamDetails, assuming it's a structure with necessary fields
    @State private var teamDetails: TeamDetails // Example type, replace with your actual model
    ...
    var body: some View {
        ...
        .padding(.horizontal, 20)) {
            TeamFormationSections(
                ...
                teamDetails: $teamDetails,  // This must come before other parameters
