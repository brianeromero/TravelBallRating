    ...
    var body: some View {
        ...
        .onAppear {
            ...
            if let team = viewModel.selectedTeam {
                ...
                print("Fetching current day of week for team: \(team.teamName) and day: \(defaultDay.displayName)")
                Task {
                    _ = await viewModel.fetchCurrentDayOfWeek(for: team, day: defaultDay, selectedDayBinding: Binding(get: { viewModel.selectedDay }, set: { viewModel.selectedDay = $0 }))
                }
            } else {
...
struct DayPickerView: View {
    ...
    var body: some View {
        ...
        .padding()
        // MARK: Navigation bar styling to match "teams Near Me"
        .navigationBarTitleDisplayMode(.inline)
        .toolbar {
            ToolbarItem(placement: .principal) {
                Text("Day of the Week")
                    .font(.title) // same size as "teams Near Me"
                    .fontWeight(.bold)
