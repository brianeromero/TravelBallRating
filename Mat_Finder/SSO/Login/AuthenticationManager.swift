...
class AuthenticationManager {
    ...
    /// Converts Firebase User into a Mat_Finder.User model
    func createUserFromFirebaseUser(_ firebaseUser: FirebaseAuth.User, completion: @escaping (Result<Mat_Finder.User, Error>) -> Void) {
        let appUser = Mat_Finder.User(
