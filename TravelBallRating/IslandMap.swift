...
struct IslandMap: View {
    ...
    var body: some View {
        ...
        .onAppear {
            print("team Map appeared with teams count: \(islands.count)")
...
struct IslandMap_Previews: PreviewProvider {
    static var previews: some View {
        ...
        let sampleIslands: [CustomMapMarker] = [
            CustomMapMarker(id: UUID(), coordinate: CLLocationCoordinate2D(latitude: 37.7749, longitude: -122.4194), title: "Sample team", team: nil)
        ]
