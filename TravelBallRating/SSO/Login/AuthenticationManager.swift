...
class AuthenticationManager {
    ...
    /// Converts Firebase User into a TravelBallRating.User model
    func createUserFromFirebaseUser(_ firebaseUser: FirebaseAuth.User, completion: @escaping (Result<TravelBallRating.User, Error>) -> Void) {
        let appUser = TravelBallRating.User(
