...
enum AccountAlertType {
    case successAccount
    case successAccountAndTeam
    case notice

    var title: String {
        switch self {
        case .successAccount, .successAccountAndTeam: return "Congratulations!"
    ...
    var defaultMessage: String {
        ...
        case .successAccountAndTeam: return "Account Created Successfully and your team has been added to the database! You will now be navigated back to Main Menu."
        case .notice: return ""
        }
    }
}
...
struct LoginView: View {
                        ...
                        .onAppear {
                            DispatchQueue.main.asyncAfter(deadline: .now() + 3) {
                                withAnimation {
                                    ...
                                    // Navigate to TeamMenu2
                                    navigationPath.removeLast(navigationPath.count)
                                    navigationPath.append(AppScreen.teamMenu2)
                                }
                            }
                        }
                }
    ...
    private func handleAlertDismiss() {
        ...
        switch type {
        case .successAccount, .successAccountAndTeam:
