...
struct ConsolidatedTeamMapView: View {
    @Environment(\.managedObjectContext) private var viewContext
    @FetchRequest(entity: Team.entity(), sortDescriptors: [])
    ...
    private let log = os.Logger(subsystem: Bundle.main.bundleIdentifier ?? "com.travelBallRating",
                                category: "AllTeamMapView")
    ...
    // This helper remains the same and correctly filters the teams based on the region
