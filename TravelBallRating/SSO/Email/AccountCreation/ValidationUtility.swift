...
enum ValidationError: String, Error, Equatable {
    ...
    case invalidTeamName = "Team name is required123."
...
class ValidationUtility {
    ...
    static func validateTeamName(_ name: String) -> ValidationError? {
        if name.isEmpty {
    ...
    static func validateTeamForm(
        ...
        teamWebsiteURL: URL? = nil     // Add teamWebsiteURL as optional
        ...
        do {
            ...
            // Iterate through required fields and check their corresponding team details
            for field in requiredFields {
                ...
                let value = teamDetails[keyPath: keyPath].trimmingCharacters(in: .whitespaces)
        ...
        if !teamWebsite.isEmpty {
            if validateURL(teamWebsite) != nil {
