                ...
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    Group {
                        SectionView(title: "1. User-Generated Content") {
                            Text("Mat_Finder allows users to submit and view information about Brazilian Jiu Jitsu (BJJ) teams and open mats. While we strive to provide accurate and up-to-date information, we do not guarantee the accuracy, reliability, or completeness of any content submitted by users.")
                        }

                        SectionView(title: "2. No Endorsement") {
                            Text("The inclusion of any team or open mat on Mat_Finder does not constitute an endorsement by Mat_Finder. Users are encouraged to verify the accuracy of information independently before relying on it.")
                        }

                        SectionView(title: "3. Safety and Legality") {
                            Text("Mat_Finder is designed to help BJJ practitioners find training opportunities. Users are responsible for their own safety and must exercise caution when visiting any team or open mat listed on Mat_Finder. We do not endorse, support, or promote any illegal or unsafe activities.")
                        }
