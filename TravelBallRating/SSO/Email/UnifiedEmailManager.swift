...
class UnifiedEmailManager {
    ...
    func verifyEmail(token: String, email: String, userName: String) async -> Bool {
        ...
        Welcome to TravelBallRating! You're now ready to navigate Travel Ball teams and open mats near you and all over. Share your favorite teams and training schedules with friends!
        
        About TravelBallRating:
        TravelBallRating is a passion project created by a BJJ Brown belt to help practitioners find training opportunities while traveling.
        
        Our Mission:
        Provide a free, community-driven platform for BJJ enthusiasts to share and discover open mats and teams worldwide.
        
        Get Involved:
        Report bugs, share feedback, or suggest features at: mfinder.bjj@gmail.com
        
        Thank you for joining the TravelBallRating community!
        Best regards,
        TravelBallRating Team
        """
